...
const FragmentCard=({
    ...
    return (<button className={cn(
        "flex items-start text-start gap-2 border rounded-lg mg-muted w-fit p-3 hover:bg-secondary transition-colors",
...
const AssistantMessage=({
    ...
    return (
        <div className={cn(
            "flex flex-col group px-2 pb-2", type==="ERROR"&& "text-red-600 dark:text-red-500"
        )}>
...
<div className="pl-8.5 flex flex-col gap-y-4"><span>{content}</span>
